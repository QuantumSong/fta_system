...
const XorGateNode: React.FC<XorGateNodeProps> = ({ data, selected }) => {
  return (
    <NodeResizeWrapper selected={selected} width={data.nodeWidth || DEF} height={data.nodeHeight || DEF} minWidth={36} minHeight={36} onSizeChange={data.onSizeChange} evidenceLevel={data.evidenceLevel}>
      {({ width, height }) => (
        <div
          ...
          style={{ width, height, filter: selected ? 'drop-shadow(0 0 2px #13c2c2)' : undefined }}
        >
          ...
          <svg width="100%" height="100%" viewBox="0 0 50 50" preserveAspectRatio="xMidYMid meet">
            <path d="M5,8 Q5,2 13,2 L37,2 Q45,2 45,8 L45,28 Q45,48 25,48 Q5,48 5,28 Z" fill="#fff" stroke="#13c2c2" strokeWidth="2" />
            <path d="M5,8 Q25,18 45,8" fill="none" stroke="#13c2c2" strokeWidth="2" />
            <path d="M3,2 Q23,12 47,2" fill="none" stroke="#13c2c2" strokeWidth="2" />
            <text x="25" y="34" textAnchor="middle" fontSize="10" fill="#13c2c2" fontWeight="bold">XOR</text>
          </svg>
